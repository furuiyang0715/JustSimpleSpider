...
from EastMoneyCarticle.configs import MYSQL_HOST, MYSQL_PORT, MYSQL_USER, MYSQL_PASSWORD, MYSQL_DB, MYSQL_TABLE, \
    DC_HOST, DC_PORT, DC_USER, DC_PASSWD, DC_DB, LIST_START, LIST_END
...
if __name__ == "__main__":
    ...
    sudo docker run -itd --name ins2 --env LIST_START=100 \
    --env LIST_END=200 \
    registry.cn-shenzhen.aliyuncs.com/jzdev/jzdata/emm:v1 
    
    sudo docker run -itd --name ins3 --env LIST_START=200 \
    --env LIST_END=300 \
    registry.cn-shenzhen.aliyuncs.com/jzdev/jzdata/emm:v1 
    
    sudo docker run -itd --name ins4 --env LIST_START=300 \
    --env LIST_END=400 \
    registry.cn-shenzhen.aliyuncs.com/jzdev/jzdata/emm:v1 
    
    sudo docker run -itd --name ins5 --env LIST_START=400 \
    --env LIST_END=500 \
    registry.cn-shenzhen.aliyuncs.com/jzdev/jzdata/emm:v1 
