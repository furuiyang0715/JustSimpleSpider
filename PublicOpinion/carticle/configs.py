...
if LOCAL:
    ...
    TARGET_PASSWD = MYSQL_PASSWORD
    TARGET_DB = MYSQL_DB
else:
    TARGET_HOST = LOCAL_MYSQL_HOST
    TARGET_PORT = LOCAL_MYSQL_PORT
    TARGET_USER = LOCAL_MYSQL_USER
    TARGET_PASSWD = LOCAL_MYSQL_PASSWORD
    TARGET_DB = LOCAL_MYSQL_DB
