...
if __name__ == "__main__":
    ...
    sudo docker run -itd --name mm4 --env KEY='' --env START=747 \
    --env END=1000 \
    registry.cn-shenzhen.aliyuncs.com/jzdev/jzdata/ca:v1 
    ...
    # 600-1000 [mm4]
    # '兴业银行',
    # '兴化股份', '兴发集团', '兴图新科', '兴森快捷', '兴民智通', '兴源环境', '兴瑞科技',
    # '兴蓉环境', '兴齐眼药', '养元饮品', '冀东水泥', '冀东装备', '冀中能源', '冀凯股份', '内蒙一机', '内蒙华电',
    # '再升科技', '农业银行', '农产品', '农发种业', '农尚环境', '冠农股份', '冠城大通', '冠昊生物', '冠福股份',
    # '冠豪高新', '冰川网络', '冰轮环境', '准油股份', '凌云股份', '凌钢股份', '凌霄泵业', '凤凰传媒',
    ...
    # '山河智能', '山河药辅', '山煤国际', '山石网科', '山西汾酒', '山西焦化', '山西证券', '山西路桥', '山鹰控股',
