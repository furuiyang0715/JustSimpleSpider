...
if __name__ == "__main__":
    ...
    #
    # 500
    # '乾照光电', '二三四五', '二六三', '二局股份', '二重重装', '云内动力', '云南城投',
    # '云南旅游', '云南白药', '云南能投', '云南铜业', '云南锗业', '云图控股', '云大科技', '云天化', '云意电气',
    # '云投生态', '云海金属', '云煤能源', '云维股份', '云赛智联', '云铝股份', '五方光电', '五洋停车', '五洲交通',
    # '五洲新春', '五矿发展', '五矿稀土', '五矿资本', '五粮液', '亚世光电', '亚光股份', '亚厦股份', '亚士创能',
    # '亚太实业', '亚太科技', '亚太股份', '亚太药业', '亚威股份', '亚宝药业', '亚振家居', '亚星化学', '亚星客车',
    # '亚星锚链', '亚普股份', '亚泰国际', '亚泰集团', '亚玛顿', '亚盛集团', '亚翔集成', '亚联发展', '亚通股份',
    # '亚邦股份', '交大昂立', '交建股份', '交控科技', '交运股份', '交通银行', '亨通光电', '京东方', '京华激光',
